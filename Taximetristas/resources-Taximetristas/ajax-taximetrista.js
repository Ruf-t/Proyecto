...
$.ajax({
  ...
  //             // los botones del desplegable de viaje y terminar jornada, se vuelven a bloquear cuando se termina la jornada
  //             $('#btnIniciarViaje').prop('disabled', false).removeClass('btn-activado').addClass('btn-desactivado');
  //             $('#btnFinalizarJornada').prop('disabled', false).removeClass('btn-activado').addClass('btn-desactivado');
                                  
  //             // Deshabilitar el botón de Iniciar Jornada
  //             $('#btnIniciarJornada').prop('disabled', true).removeClass('btn-desactivado').addClass('btn-activado');
              
              
  //             $('.respuestaAJAX').slideDown();
              
  //             $('#formFinalizarJornada')[0].reset();
  //             $('#formContainer3').addClass('hidden');
              
  //             // Desactiva la funcionalidad de los contenedores desplegables
  //             $('#btnIniciarViaje, #btnFinalizarJornada').attr('data-disabled', 'true');
